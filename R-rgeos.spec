...
Version  : 0.5.1
Release  : 11
URL      : https://cran.r-project.org/src/contrib/rgeos_0.5-1.tar.gz
Source0  : https://cran.r-project.org/src/contrib/rgeos_0.5-1.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1565146629
